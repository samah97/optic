    ...
    class Validation {
        ...
        public function min($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) < $length){
                    $this->errors[] = $this->name.' field less than the minimum value';
                }
        ...
        public function max($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) > $length){
                    $this->errors[] = 'Field '.$this->name.' value greater than the maximum value';
                }
        ...
        public function equal($value){
            ...
            if($this->value != $value){
                $this->errors[] = 'Field '.$this->name.' value does not match..';
            }
            return $this;
