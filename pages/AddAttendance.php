...
$q="SELECT MAX(attendanceNumber) as maxAttendance,lenseType from client where clientId=".$_REQUEST['id'];

$r=exec_query(DBNAME, $q);
$row=mysqli_fetch_assoc($r);
$lensetype=$row['lenseType'];
?>

<div class="container">
	<div class="row">
		<div class="col-md-12">
			<h3 class="text-center">Attendance Number: <?php echo $row['maxAttendance']+1; ?> </h3>
		</div>
		<div class="col-md-12">
		<form id="addAttendance" name="addAttendance" action="action/insertClient.php?attendanceNumber=<?php echo $row['maxAttendance'];?>&fromPage=addAttendance" method="POST" onSubmit="if(!validateForm()){return false;}">
			<div class="col-md-6">
